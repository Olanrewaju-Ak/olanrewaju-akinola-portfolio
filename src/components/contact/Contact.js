			...
			<div className="contact__container">
				...
				<div className="contact__content">
					<p className="contact__message">
						I'm currently looking for an entry level role or an internship in web
						development. Kindly contact me if you have any opportunity for me. Also feel
						free to reach out to me if you have a question or just want to say hi
					</p>
					...
					<div className="connect">
						<div className="connect__email">
							...
							<a href="mailto:akinola_lanrewaju@yahoo.com" className="connect-btn">
